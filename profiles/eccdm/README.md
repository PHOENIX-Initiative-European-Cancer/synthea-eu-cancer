...
`hl7.fhir.eu.cancer-common-75ad6ed.tgz` is an **unofficial, locally built** FHIR package of the
...
**Source pin:** fork `ValhallasCat/cancer-common` @ `75ad6edd3ed73d076fcac44218dbc7c2c96cfc2c`
(2026-08-26, "Added file for links") — 5 commits ahead of `hl7-eu/cancer-common` master, containing
...
manifest (version `1.0.0-ballot.tnm-draft.75ad6ed`).
...
java -jar ~/.fhir/validator_cli.jar <bundle.json> -version 4.0.1 \
  -ig profiles/eccdm/hl7.fhir.eu.cancer-common-75ad6ed.tgz
